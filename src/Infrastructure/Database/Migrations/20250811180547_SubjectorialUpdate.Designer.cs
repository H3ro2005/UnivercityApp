...
namespace Infrastructure.Database.Migrations
{
    ...
    [Migration("20250811180547_SubjectorialUpdate")]
    partial class SubjectorialUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Faculties.FacultyUsedSubject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_faculty_used_subjects");

                    b.HasIndex("FacultyId")
                        .HasDatabaseName("ix_faculty_used_subjects_faculty_id");

                    b.ToTable("faculty_used_subjects", "public");
                });
            ...
            modelBuilder.Entity("Domain.Faculties.FacultyUsedSubject", b =>
                {
                    b.HasOne("Domain.Faculties.Faculty", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_faculty_used_subjects_faculties_faculty_id");
                });
